...
const AddFuelModal = ({ open, onClose }) => {
  ...
  return (
    <React.Fragment>
      <Container fluid>
        <Modal size="lg" title="Add Fuel" isOpen={open} onClose={onClose}>
                ...
                <FormGroup className="mb-3">
                  ...
                  <select
                    className={`form-select ${
                      formik.touched.fuelType && formik.errors.fuelType ? "is-invalid" : ""
                    }`}
                    id="fuelType"
                    name="fuelType"
                  ...
                  {formik.touched.fuelType && formik.errors.fuelType && (
                    <FormFeedback className="d-block">{formik.errors.fuelType}</FormFeedback>
                  )}
                </FormGroup>
              </Col>
              <Col>
